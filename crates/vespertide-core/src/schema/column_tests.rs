...
fn builder_preserves_round_trip_with_existing_literal() {
    ...
    let from_builder = ColumnDef::new("name", ColumnType::Simple(SimpleColumnType::Text), false);
...
#[case(SimpleColumnType::Macaddr, "MACADDR")]
#[case(SimpleColumnType::Xml, "XML")]
fn test_simple_column_type_sql_type(#[case] column_type: SimpleColumnType, #[case] expected: &str) {
