...
#[case::mysql("mysql", DatabaseBackend::MySql)]
#[case::sqlite("sqlite", DatabaseBackend::Sqlite)]
fn test_delete_column_with_index_constraint(#[case] title: &str, #[case] backend: DatabaseBackend) {
    let schema = vec![TableDef {
        name: "posts".into(),
        description: None,
        columns: vec![
...
#[case::mysql("mysql", DatabaseBackend::MySql)]
#[case::sqlite("sqlite", DatabaseBackend::Sqlite)]
fn test_delete_column_with_fk_constraint(#[case] title: &str, #[case] backend: DatabaseBackend) {
    let schema = vec![TableDef {
        name: "orders".into(),
        description: None,
        columns: vec![
...
#[case::mysql("mysql", DatabaseBackend::MySql)]
#[case::sqlite("sqlite", DatabaseBackend::Sqlite)]
fn test_delete_column_with_pk_constraint(#[case] title: &str, #[case] backend: DatabaseBackend) {
    let schema = vec![TableDef {
        name: "order_items".into(),
        description: None,
        columns: vec![
