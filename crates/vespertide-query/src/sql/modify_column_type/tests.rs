...
#[case::modify_enum_with_default_mysql("modify_enum_with_default_mysql", DatabaseBackend::MySql)]
#[case::modify_enum_with_default_sqlite("modify_enum_with_default_sqlite", DatabaseBackend::Sqlite)]
