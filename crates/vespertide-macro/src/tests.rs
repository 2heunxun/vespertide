...
fn test_generate_migration_code() {
    ...
    let generated = generate_migration_code(&pool, version_table, &[block], false).unwrap();
...
fn test_generate_migration_code_empty_migrations() {
    ...
    let generated = generate_migration_code(&pool, version_table, &[], false).unwrap();
    let generated_str = generated.to_string();
...
fn test_generate_migration_code_multiple_blocks() {
    ...
    let generated = generate_migration_code(&pool, "migrations", &[block1, block2], false).unwrap();
    let generated_str = generated.to_string();
...
fn test_generate_migration_code_delegates_runtime_execution() {
    ...
    let generated = generate_migration_code(&pool, "vespertide_version", &[block], false).unwrap();
    let generated_str = generated.to_string();
...
fn test_generate_migration_code_verbose() {
    ...
    let generated = generate_migration_code(&pool, version_table, &[block], true).unwrap();
    let generated_str = generated.to_string();
